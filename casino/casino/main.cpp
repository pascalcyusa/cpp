...
void rules() {
  ...
  cout << "\t3. If you bet on a wrong number, you will lose your betting "
          "amount\n";
}
...
int main() {
  ...
  srand(
      static_cast<unsigned int>(time(nullptr))); // "Seed" the random generator
  ...
  cout << "\n" << playerName << ", put some cash to play: $";
  cin >> amount;
  cout << endl;
  ...
  do {
    ...
    if (dice == guess) {
      cout << "\n\t\u26C4 Good Luck!! You won $" << bettingAmount * 10 << endl
           << endl;
